      ...
      <div className="flex items-center gap-3 mb-8" id="apps-hub-header">
        ...
        <div>
          <h1 className="font-heading font-bold text-2xl md:text-3xl text-foreground">
            {t("apps_hub.title", "Apps Hub")}
          </h1>
          <p className="text-xs md:text-sm text-muted-foreground mt-0.5">
            {t("apps_hub.desc", "Access supplementary utility and helper applications built for your dashboard.")}
          </p>
        </div>
      </div>
          ...
          >
            ...
            {app.thumbnail ? (
              <div className="h-44 w-full border-b relative overflow-hidden bg-muted">
                ...
                <img src={app.thumbnail} alt={app.name} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
            ...
            <div className="p-5 flex-1 flex flex-col justify-between">
              <div>
                ...
                <h3 className="font-heading font-semibold text-lg text-foreground mb-1 transition-colors">
                  {app.name}
                </h3>
